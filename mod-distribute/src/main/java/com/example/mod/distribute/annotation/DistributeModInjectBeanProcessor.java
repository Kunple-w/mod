 ...
 * @author wangyongxu
 */
public class DistributeModInjectBeanProcessor extends AbstractAnnotationBeanPostProcessor implements ApplicationContextAware {
     ...
     */
    public DistributeModInjectBeanProcessor() {
        super(ModInject.class);
    }
